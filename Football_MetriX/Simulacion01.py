...
# Input: matches df
# Output: matches df including Probability columns, margins of bet houses
...
# Input: matches df
# Output: matches df filtered by specified season and division
...
# Input: matches df of a specific season and division
# Output: teams df for a specific season and division
...
# Input: matches df of a specific season and division
# Output: empty results table df of a specific season and division
...
# Input: empty results table df and matches df filtered by a specific season and division
...
# Input: unordered results table df
# Output: results table df with performance indicators sorted by performance
...
# Input: matches df filtered by a specific season and division
# Output: empty positions table d
...
# Output: updated table by position df
...
if __name__ == "__main__":
    ...
    matches = pd.read_csv('Football_MetriX\df_Euro_Leagues_utf-8.csv')
    season = '2018-2019'
    division = 'E0'
    iterations = 50
    ...
    print(final_table[0])
    final_table[0].to_csv(f'Football_MetriX\seasons_simulations\performances\Experimento_triangulacion\{season}_{division}_performance_{iterations}_iterations.csv')
    print(final_table[1])
    final_table[1].to_csv(f'Football_MetriX\seasons_simulations\positions\Experimento_triangulacion\{season}_{division}_position_{iterations}_iterations.csv', index=False)