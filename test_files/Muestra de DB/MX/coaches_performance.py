...
if __name__ == "__main__":
    ...
    #print(coach_profile(matches, metron, 'Quique Septien'))
    performances = coachs_performances(matches, metron, lista_DTs)
    print(performances)
    performances.to_excel('coachs_profiles_04-04-2021.xlsx',sheet_name='profiles')
    #print(find_index(0.56,escenario_list))
    #temp = coach_profile(matches, metron, 'Roberto Hernandez')
    #print(temp)
    #print(metron.loc[metron['Escenario']==0.25])
    #temporal = metron.loc[metron['Escenario'] == 0.24]
    #print(temporal['FTHG'][34])
    #temporal = metron[0:1]
    #print(temporal)
    #temporal = find_index(0.06, escenario_list)
    #print(temporal)
    #print(metron.loc[metron['Escenario'] == temporal])
